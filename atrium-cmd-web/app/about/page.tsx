...
export const metadata: Metadata = {
  title: "About",
  description:
    "Atrium CMD is a Los Angeles-based AI workflow automation product, built for legal operations, confidentiality, and practical automation.",
};
...
const principles = [
  {
    ...
    body: "Atrium CMD is built by a Los Angeles-based team focused on AI workflow automation for legal operations.",
  },
  {
    icon: Lock,
  ...
  return (
    <>
      <PageHeader
        ...
        lede="Atrium CMD is a product in active development — built with direct feedback from practicing attorneys and legal operations professionals, not around it."
      />
