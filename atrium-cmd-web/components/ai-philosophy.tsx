...
const principles = [
  ...
  },
  {
    ...
    body: "Atrium never interprets the law or advises a course of action. It organizes facts; attorneys make the judgment calls.",
  },
  {
    icon: Lock,
        ...
        <Reveal delay={0.2} className="mt-10">
          <div className="rounded-2xl bg-zinc-950 px-8 py-12 text-center text-zinc-100 sm:px-10">
            ...
            <p className="mx-auto mt-3 max-w-2xl font-serif text-[26px] leading-snug">
              Atrium never gives legal advice. It surfaces evidence and options —
