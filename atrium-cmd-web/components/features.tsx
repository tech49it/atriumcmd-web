...
const features: Feature[] = [
  ...
  },
  {
    ...
    body: "Atrium recommends; it never acts. Nothing is sent, filed, or changed without an attorney's explicit approval.",
  },
  {
    icon: Inbox,
    ...
    <section id="features" className="scroll-mt-24 border-t border-border/60 py-24 sm:py-28">
      <div className="container">
        <SectionHeading
          ...
          lede="Atrium works across your existing stack and surfaces only what actually needs attention today, with the reasoning attached."
        />
