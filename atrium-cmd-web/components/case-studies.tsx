...
const caseStudies = [
  {
    ...
    body: "The first Atrium CMD module: an overnight job that reads across a firm's calendar, inbox, and matters, then assembles a single prioritized, sourced brief — refined with practicing attorneys before wider release.",
  },
];
    ...
    <section id="case-studies" className="scroll-mt-24 border-t border-border/60 py-24 sm:py-28">
      <div className="container">
        <SectionHeading
          ...
          lede="Product engineering notes on what we're actually shipping — not customer testimonials. Atrium CMD is early; here's what's real today."
        />
